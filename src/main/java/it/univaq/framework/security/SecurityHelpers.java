    ...
    public static boolean checkPermissionScript(HttpServletRequest request){
        try {
            if(request.getSession().getAttribute("userid") != null) {
                ...
                Service myService = ServiceResource.getServiceByScriptData(script);
                Group myGroup = GroupResource.getGroupByUserData(Integer.parseInt(request.getSession().getAttribute("userid").toString()));
